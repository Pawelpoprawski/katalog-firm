  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10">
      ...
      <nav className="flex items-center gap-2 text-sm text-slate-600 mb-6" aria-label="Breadcrumb">
        ...
        <span>/</span>
        <span className="font-semibold text-slate-900">Rejestracja</span>
      </nav>

      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <h1 className="text-2xl font-bold text-slate-900 mb-6">Utwórz konto</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-base focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
            />
            <p className="mt-1 text-xs text-slate-500">Minimum 6 znaków</p>
          </div>
        ...
        <div className="mt-6 text-center text-sm text-slate-600">
          Masz już konto?{" "}
          <Link href="/login" className="font-semibold text-primary hover:text-red-700">
            Zaloguj się
          </Link>
        </div>
      </div>
